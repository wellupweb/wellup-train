        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="card shadow rounded-5 mb-5" data-aos="fade-up">
              <div class="icon mt-5 ms-4 rounded-2 d-flex justify-content-center align-items-center"><i class="fa-solid fa-pen-ruler"></i></div>
              <div class="card-body">
                <h5 class="card-title">Service Heading</h5>
                <p class="card-text">There are many variations of passages of Lorem Ipsum available but the majority have suffered</p>
              </div>
            </div>
          </div>
